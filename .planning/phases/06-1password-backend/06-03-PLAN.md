...
Purpose: Users should never be blocked from using ssherpa because 1Password is locked/unavailable. The tool must gracefully fall back to cached data and auto-recover when 1Password becomes available.
