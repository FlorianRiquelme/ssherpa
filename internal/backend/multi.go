...
//
// Servers from ssherpa_config (auto-generated SSH include file) are filtered out
// before deduplication to prevent phantom duplicates when 1Password items are renamed.
func (m *MultiBackend) ListServers(ctx context.Context) ([]*domain.Server, error) {
	...
	// Filter out ssherpa-generated mirrors (from ~/.ssh/ssherpa_config)
	// These are always redundant copies of 1Password data
...
// isSsherpaGenerated checks if a server was generated by ssherpa.
// We detect this by checking if the server is from ssh-config source
// and the Notes field contains "ssherpa_config" (from the auto-generated include file).
