...
func TestWriteSSHIncludeFile_FullServer(t *testing.T) {
	...
	assert.Contains(t, contentStr, "# Generated by ssherpa - DO NOT EDIT MANUALLY")
...
func TestWriteSSHIncludeFile_EmptyServers(t *testing.T) {
	...
	assert.Contains(t, contentStr, "# Generated by ssherpa")
...
func TestEnsureIncludeDirective_NewFile(t *testing.T) {
	...
	assert.Contains(t, contentStr, "# ssherpa 1Password integration")
...
`
	...
	for i, line := range lines {
		if strings.Contains(line, "# ssherpa 1Password integration") {
...
func TestEnsureIncludeDirective_AlreadyPresent(t *testing.T) {
	...
	existingContent := `# ssherpa 1Password integration
Include ` + includePath + `
