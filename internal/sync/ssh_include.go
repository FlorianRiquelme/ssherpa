...
//
// Default includePath: ~/.ssh/sshjesus_config
func WriteSSHIncludeFile(servers []*domain.Server, includePath string) error {
	// Build the content
	var content strings.Builder

	// Write header
	content.WriteString("# Generated by sshjesus - DO NOT EDIT MANUALLY\n")
...
// directive pointing to the sshjesus include file.
//
...
func EnsureIncludeDirective(sshConfigPath, includePath string) error {
	...
	newContent.WriteString("# sshjesus 1Password integration\n")
